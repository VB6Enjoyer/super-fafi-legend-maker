...
export const COUNTRIES: Country[] = [
  ...
  { name: 'British Indian Ocean Territory (the)', code: 'IO', flag: '🇮🇴' },
  ...
  { name: 'Cayman Islands (the)', code: 'KY', flag: '🇰🇾' },
  { name: 'Central African Republic (the)', code: 'CF', flag: '🇨🇫' },
  { name: 'Chad', code: 'TD', flag: '🇹🇩' },
  { name: 'Chile', code: 'CL', flag: '🇨🇱' },
  { name: 'China', code: 'CN', flag: '🇨🇳' },
  { name: 'Christmas Island', code: 'CX', flag: '🇨🇽' },
  { name: 'Cocos (Keeling) Islands (the)', code: 'CC', flag: '🇨🇨' },
  { name: 'Colombia', code: 'CO', flag: '🇨🇴' },
  { name: 'Comoros (the)', code: 'KM', flag: '🇰🇲' },
  { name: 'Congo (the Democratic Republic of the)', code: 'CD', flag: '🇨🇩' },
  { name: 'Congo (the)', code: 'CG', flag: '🇨🇬' },
  { name: 'Cook Islands (the)', code: 'CK', flag: '🇨🇰' },
  ...
  { name: 'Dominican Republic (the)', code: 'DO', flag: '🇩🇴' },
  ...
  { name: 'Falkland Islands (the) [Malvinas]', code: 'FK', flag: '🇫🇰' },
  { name: 'Faroe Islands (the)', code: 'FO', flag: '🇫🇴' },
  { name: 'Fiji', code: 'FJ', flag: '🇫🇯' },
  { name: 'Finland', code: 'FI', flag: '🇫🇮' },
  { name: 'France', code: 'FR', flag: '🇫🇷' },
  { name: 'French Guiana', code: 'GF', flag: '🇬🇫' },
  { name: 'French Polynesia', code: 'PF', flag: '🇵🇫' },
  { name: 'French Southern Territories (the)', code: 'TF', flag: '🇹🇫' },
  { name: 'Gabon', code: 'GA', flag: '🇬🇦' },
  { name: 'Gambia (the)', code: 'GM', flag: '🇬🇲' },
  ...
  { name: 'Holy See (the)', code: 'VA', flag: '🇻🇦' },
  ...
  { name: 'Korea (the Democratic People\'s Republic of)', code: 'KP', flag: '🇰🇵' },
  { name: 'Korea (the Republic of)', code: 'KR', flag: '🇰🇷' },
  { name: 'Kuwait', code: 'KW', flag: '🇰🇼' },
  { name: 'Kyrgyzstan', code: 'KG', flag: '🇰🇬' },
  { name: 'Lao People\'s Democratic Republic (the)', code: 'LA', flag: '🇱🇦' },
  ...
  { name: 'Marshall Islands (the)', code: 'MH', flag: '🇲🇭' },
  ...
  { name: 'Moldova (the Republic of)', code: 'MD', flag: '🇲🇩' },
  ...
  { name: 'Philippines (the)', code: 'PH', flag: '🇵🇭' },
  ...
  { name: 'Russian Federation (the)', code: 'RU', flag: '🇷🇺' },
  ...
  { name: 'Turks and Caicos Islands (the)', code: 'TC', flag: '🇹🇨' },
  { name: 'Tuvalu', code: 'TV', flag: '🇹🇻' },
  { name: 'Uganda', code: 'UG', flag: '🇺🇬' },
  { name: 'Ukraine', code: 'UA', flag: '🇺🇦' },
  { name: 'United Arab Emirates (the)', code: 'AE', flag: '🇦🇪' },
  { name: 'United Kingdom of Great Britain and Northern Ireland (the)', code: 'GB', flag: '🇬🇧' },
  { name: 'United States Minor Outlying Islands (the)', code: 'UM', flag: '🇺🇲' },
  { name: 'United States of America (the)', code: 'US', flag: '🇺🇸' },
